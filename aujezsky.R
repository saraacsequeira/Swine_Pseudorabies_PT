...
# 1 - Pig farm's distribution by LVS (local veterinary service) - HOW TO HAVE A LAYER WITH THAT?
...
# Percentage of pig farms currently classified (in general and farm specified)
...
# Estado geral das classificações sanitárias;
